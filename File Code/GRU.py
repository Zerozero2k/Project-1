...
from keras.layers import Lambda, Reshape, Permute, Input, add, Conv2D, TimeDistributed, Flatten, Conv2DTranspose, MaxPooling2D, GRU
...
GRU_flatten_output = GRU(2304)(flattenLayer)
GRU_2D_output      = Reshape((12, 12, 16))(GRU_flatten_output)

decode_conv1 = Conv2DTranspose(4, (3,3), strides= (2,2), padding="same", activation="relu")(GRU_2D_output)
