...
from keras.layers import Lambda, Reshape, Permute, Input, add, Conv2D, TimeDistributed, Flatten, Conv2DTranspose, MaxPooling2D, LSTM
...
LSTM_flatten_output = LSTM(2304)(flattenLayer)
LSTM_2D_output      = Reshape((12, 12, 16))(LSTM_flatten_output)

decode_conv1 = Conv2DTranspose(4, (3,3), strides= (2,2), padding="same", activation="relu")(LSTM_2D_output)
