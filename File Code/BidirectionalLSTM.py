...
from keras.layers import Lambda, Reshape, Permute, Input, add, Conv2D, TimeDistributed, Flatten, Conv2DTranspose, MaxPooling2D, Bidirectional, LSTM
...
encode_conv5 = TimeDistributed(Conv2D(16, (3,3), padding="same", activation="relu"))(max2)
encode_conv6 = TimeDistributed(Conv2D(16, (3,3), padding="same", activation="relu"))(encode_conv5)
max3         = TimeDistributed(MaxPooling2D((2,2), strides= (2,2)))(encode_conv6)

flattenLayer = TimeDistributed(Flatten())(max3)

BiLSTM_flatten_output = Bidirectional(LSTM(1152))(flattenLayer)
BiLSTM_2D_output      = Reshape((12, 12, 16))(BiLSTM_flatten_output)

decode_conv1 = Conv2DTranspose(4, (3,3), strides= (2,2), padding="same", activation="relu")(BiLSTM_2D_output)
decode_conv2 = Conv2DTranspose(8, (3,3), strides= (2,2), padding="same", activation="relu")(decode_conv1)
decode_conv3 = Conv2DTranspose(16, (3,3), strides= (2,2), padding="same", activation="relu")(decode_conv2)
